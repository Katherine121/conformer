...
class ClassifyConformer(nn.Module):
    """
    ...
    def __init__(
        ...
        super(ClassifyConformer, self).__init__()

        self.conv = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=40, kernel_size=1, stride=1, padding=0, bias=False),
            nn.BatchNorm2d(40),
            nn.ReLU(),

            nn.Conv2d(in_channels=40, out_channels=40, kernel_size=3, stride=1, padding=1, groups=40, bias=False),
            nn.BatchNorm2d(40),
            nn.ReLU(),

            nn.Conv2d(in_channels=40, out_channels=30, kernel_size=1, stride=1, padding=0, bias=False),
            nn.BatchNorm2d(30)
        )
        ...
        self.fc1 = Linear(encoder_dim, num_classes, bias=False)
